...
expdir=/home/wuql/flink-cluster/experiments/cachekit-ready-gated-prefetch-p0-q9-100m-x86-20260903
project=ckx867a9p0
compose=/home/wuql/bin/docker-compose
rest=http://127.0.0.1:10688
prom=http://127.0.0.1:11721
...
export GOLDEN_CONTAINER_CPUSET_MEMS_JSON='{"ckx867a9p0_jobmanager_1":"0","ckx867a9p0_taskmanager1_1":"0","ckx867a9p0_taskmanager2_1":"1","ckx867a9p0_prometheus_1":"1","ckx867a9p0_pushgateway_1":"1"}'
...
result={
 'schema':'cachekit-ready-gated-prefetch-p0-leg-v1','valid':True,
 'source_commit':source,'artifact_sha256':artifact,'platform':'x86','query':query,
