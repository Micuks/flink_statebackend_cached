...
target_exp=/home/wuql/flink-cluster/experiments/cachekit-ready-gated-prefetch-p0-q9-100m-x86-20260903
...
[[ -z $(docker ps -q) ]] || {
  echo "host has running containers; refusing P0 staging" >&2
...
scp -q "$script_dir/audit_value_prefetch.py" "$script_dir/summarize.py" "$host:$target_exp/"
