...
base_source=7a9e568dcbd75ab4f24e7a33a4339f5cd1cf8000
expected_source=5a9d1e656715a403afac72ee1a516876ddbfb7f1
...
git -C "$repo" diff --quiet "$frozen_source" "$base_source" -- \
  flink-state-backends/flink-statebackend-rocksdb flink-table/flink-table-runtime || {
...
manifest=$repo/flink-state-backends/flink-statebackend-cachekit/target/CANDIDATE_BUILD.txt
{
  ...
  echo "base_source_commit=$base_source"
