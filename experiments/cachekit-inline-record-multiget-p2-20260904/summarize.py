#!/usr/bin/env python3
"""Summarize the P2 q9 paired screen and its activation/performance gates."""
...
def main() -> None:
    ...
    parser.add_argument("--output-prefix", default="P2_RESULT")
    ...
    for result_path in sorted((args.expdir / "results" / "raw").glob("*/result.json")):
        ...
        activation_path = leg / "IMMEDIATE_RECORD_AUDIT.json"
        activation = (
    ...
    result = {
        "schema": "cachekit-inline-record-multiget-p2-summary-v1",
    ...
    lines = [
        "# CacheKit inline record-key MultiGet P2 q9 result",
        "",
