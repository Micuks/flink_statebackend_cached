...
import org.apache.flink.contrib.streaming.state.cacheplus.ManagedPagePool;
...
public class OffHeapKVStore implements Closeable {
    ...
    private final CachingPlusKeyedStateBackend<?> ownerBackend;
    ...
    public OffHeapKVStore(ManagedPagePool pagePool, CachingPlusKeyedStateBackend<?> ownerBackend) {
        this.pagePool = Preconditions.checkNotNull(pagePool);
    ...
    public OffHeapKVStore(ManagedPagePool pagePool,
                          CachingPlusKeyedStateBackend<?> ownerBackend,
