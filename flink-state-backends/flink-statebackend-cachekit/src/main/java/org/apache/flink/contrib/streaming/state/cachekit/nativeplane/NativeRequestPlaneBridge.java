...
public final class NativeRequestPlaneBridge implements NativeRequestPlane {
   ...
   * zero reserved field. A negative entry uses flag {@link #FILL_VALUE_NEGATIVE_FLAG} and must have
   * zero offset and length. {@code fillResults} receives status and error integers.
   */
  ...
  private static void requireCapacity(ByteBuffer buffer, int count, int recordBytes, String name) {
