...
public class CacheKitStateBackend extends AbstractStateBackend
    ...
    private final boolean nativeMapDistinctPreparedCommitEnabled;
    ...
    public CacheKitStateBackend(
            ...
            boolean nativeMapDistinctPreparedCommitEnabled,
        ...
        this.nativeMapDistinctPreparedCommitEnabled = nativeMapDistinctPreparedCommitEnabled;
    ...
    boolean nativeMapDistinctBatchPrefetchCrossColumnWaveEnabledForTesting() {
        return nativeMapDistinctBatchPrefetchCrossColumnWaveEnabled;
    }
    ...
    public StateBackend configure(ReadableConfig config, ClassLoader classLoader)
        ...
        final boolean nativeMapDistinctPreparedCommitEnabled =
                nativeMapDistinctBatchPrefetchEnabled
                        && config.get(
                                CacheKitStateBackendFactory
                                        .NATIVE_MAP_DISTINCT_PREPARED_COMMIT_ENABLED);
        ...
        final boolean nativeMapDistinctBatchPrefetchDeferredWaveDualWorkerEnabled =
                nativeMapDistinctBatchPrefetchDeferredWaveEnabled
                        && config.get(
                                CacheKitStateBackendFactory
